...
extension UINavigationBar {
    ...
    class public func globalCustomBar(backgroundColor: UIColor = .white, titleTextAttributes: [NSAttributedStringKey: Any] =
        [NSAttributedStringKey.foregroundColor: UIColor(hexString: "222222")!,
    ...
    public func customBar(backgroundColor: UIColor = .white, titleTextAttributes: [NSAttributedStringKey: Any] =
        [NSAttributedStringKey.foregroundColor: UIColor(hexString: "222222")!,
         NSAttributedStringKey.font: UIFont.boldSystemFont(ofSize: 18)]) {
